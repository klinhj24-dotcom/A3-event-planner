...
import {
  Mail, Plus, Trash2, Loader2, CheckCircle2, ExternalLink, Settings as SettingsIcon, FileText, X
} from "lucide-react";
    ...
    <AppLayout>
      <div className="space-y-8 max-w-2xl">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your Gmail integration and email templates.</p>
        </div>
